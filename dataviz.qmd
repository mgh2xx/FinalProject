...
for ax, season in zip(axs, [1, 2]):
    ...
    plot_c = sns.lineplot(data=season_data[season_data["About"] == "Athlete C"], x="Date", y="Prop_Jump_High", color='green', ax=ax)
    ...
    # Set x-axis ticks to selected percentiles
...
plt.title("No clear trend appears amongst one-season players, whereas two-season players show growth in their second season, as highlighted by", x = -1.04, y = 1.1, fontsize = 12, ha = "left")
fig.text(0.5115, 0.964, "Athlete C", color = "green", fontsize = 12)
